...
export function SettingsView() {
    ...
    const handleSendVerificationCode = async () => {
        ...
        try {
            const { success, code } = await sendEmail({ 
                to: email, 
                subject: 'Your Bachat Buddy Verification Code',
                body: '' // Body is generated by the flow
            });
            if (success && code) {
                setSentCode(code);
                setIsCodeSent(true);
            ...
            <Dialog open={is2faDialogOpen} onOpenChange={setIs2faDialogOpen}>
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            We will send a verification code to your email ({form.getValues('email')}). Enter the code below to enable 2FA.
                        </DialogDescription>
                    </DialogHeader>
                    <div className="py-4 space-y-4">
                         <Button onClick={handleSendVerificationCode} className="w-full" disabled={isCodeSent || isSendingCode}>
